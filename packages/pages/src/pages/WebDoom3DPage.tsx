...
function WebDoom3DPage(): ReactElement {
  ...
  const initializeEngine = async (arrayBuffer: ArrayBuffer) => {
    ...
    const renderer = createCanvas3DRenderer(canvasRef.current, wadFile);
    renderer.init({
      width: 640,
      height: 480,
      scale: 1,
  ...
  const handleScreenshot = () => {
    ...
    try {
      ...
      canvasRef.current.toBlob((blob) => {
        ...
        link.href = url;
        link.download = `doom-3d-screenshot-${Date.now()}.png`;
        link.click();
  ...
  const handleStartRecording = () => {
    ...
    try {
      ...
      mediaRecorder.onstop = () => {
        ...
        const link = document.createElement('a');
        link.href = url;
        link.download = `doom-3d-recording-${Date.now()}.webm`;
        link.click();
    ...
    <div className="web-doom-page">
      <div className="web-doom-container">
        <header className="page-header">
          <h1>Web DOOM - 3D Renderer</h1>
          <p>First-person view with raycasting</p>
        </header>
        ...
        <div className="game-container">
          ...
          <div className="game-info">
            <h3>3D Raycasting Renderer</h3>
            <p>
              This renderer uses raycasting to create a first-person 3D view, similar to the original DOOM.
              It supports texture mapping and provides an immersive gaming experience.
            </p>
            <h3>Controls</h3>
            <ul>
